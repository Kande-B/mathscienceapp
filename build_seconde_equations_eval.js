...
<head>
    ...
    <title>Évaluation Bilan - Équations 1er Degré (Seconde Pro)</title>
    <!-- Tailwind CSS -->
    ...
    <main class="max-w-5xl mx-auto px-4 py-8 space-y-12">
        ...
        <div class="bg-slate-900 text-white p-6 md:p-8 rounded-3xl shadow-xl border border-slate-800 space-y-4">
            <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div>
                    ...
                    <h2 class="text-3xl font-extrabold font-heading text-white">Évaluation : Équations du 1er Degré</h2>
                    <p class="text-sm text-slate-300 max-w-2xl">Sujet officiel sur 20 points évaluant la maîtrise du calcul algébrique, la résolution d'équations techniques et la démarche d'analyse de problème professionnel.</p>
                </div>
        ...
        <div class="space-y-6 text-xs">
            ...
            <section class="bg-white p-6 rounded-3xl border border-slate-200 card-shadow space-y-4">
                ...
                <div class="space-y-3">
                    <p class="font-semibold text-slate-800">1.1 Résoudre les deux équations directes suivantes (2 pts) :</p>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 font-mono text-slate-700">
                        ...
                        <div class="p-3 bg-slate-50 rounded-xl border border-slate-200">b) $-6x = 42$</div>
                    </div>
            ...
            <section class="bg-white p-6 rounded-3xl border border-slate-200 card-shadow space-y-4">
                <div class="flex items-center justify-between border-b border-slate-100 pb-3">
                    <h3 class="font-bold text-slate-900 text-sm">Partie 2 • Résolution d'Équations Générales (6 Points)</h3>
                    <span class="bg-slate-100 text-slate-700 font-bold px-2.5 py-1 rounded-full text-[11px]">6 Pts</span>
                </div>

                <div class="space-y-3">
                    <p class="font-semibold text-slate-800">Résoudre dans $\mathbb{R}$ en détaillant les étapes de calcul :</p>
                    <div class="space-y-2 font-mono text-slate-700">
                        <div class="p-3 bg-slate-50 rounded-xl border border-slate-200">2.1 $7x - 15 = 2x + 20$ (2 pts)</div>
                        <div class="p-3 bg-slate-50 rounded-xl border border-slate-200">2.2 $4(2x - 3) = 3(x + 6)$ (2 pts)</div>
            ...
            <section class="bg-white p-6 rounded-3xl border border-slate-200 card-shadow space-y-4">
                <div class="flex items-center justify-between border-b border-slate-100 pb-3">
                    <h3 class="font-bold text-slate-900 text-sm">Partie 3 • Problème Professionnel Contextualisé (8 Points)</h3>
                ...
                <div class="space-y-3 text-slate-700 leading-relaxed">
                    <div class="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-2">
                        ...
                        <p>
                            Une entreprise de maintenance industrielle loue un groupe électrogène pour ses chantiers. Deux loueurs proposent des tarifs concurrents : <br>
                            • <strong>Tarif A :</strong> Forfait fixe de 240 € + 35 € par jour d'utilisation. <br>
                            • <strong>Tarif B :</strong> Aucun forfait fixe, mais 55 € par jour d'utilisation. <br>
                            On désigne par $x$ le nombre de jours de location.
                        </p>
                    </div>

                    <div class="space-y-2 font-medium">
                        <p><strong>3.1 (2 pts) :</strong> Exprimer le coût $C_A(x)$ et $C_B(x)$ en fonction de $x$.</p>
                        <p><strong>3.2 (2 pts) :</strong> Écrire l'équation traduisant l'égalité des coûts des deux tarifs.</p>
                        <p><strong>3.3 (2 pts) :</strong> Résoudre cette équation pour déterminer le nombre de jours $x$.</p>
                        <p><strong>3.4 (2 pts) :</strong> Quel tarif recommander pour un chantier de 15 jours ? Justifier le choix.</p>
                    </div>
                </div>
            </section>
            ...
            <section class="bg-white p-6 rounded-3xl border border-slate-200 card-shadow space-y-4">
                <div class="flex items-center justify-between border-b border-slate-100 pb-3">
                    <h3 class="font-bold text-slate-900 text-sm">Partie 4 • Analyse & Esprit Critique (2 Points)</h3>
                    <span class="bg-slate-100 text-slate-700 font-bold px-2.5 py-1 rounded-full text-[11px]">2 Pts</span>
                </div>

                <div class="space-y-2 text-slate-700">
                    <p class="font-semibold text-slate-900">Un élève a rédigé la résolution suivante :</p>
                    <div class="p-3 bg-rose-50 border border-rose-200 rounded-xl font-mono text-rose-950">
                        $-4x = 12 \implies x = 12 + 4 \implies x = 16$.
                    </div>
                    <p class="text-slate-800">Identifier l'erreur commise par l'élève et donner la vraie solution.</p>
                </div>
            </section>

            <!-- SECTION CORRIGÉ DÉTAILLÉ (DÉPLIANTE ET IMPRIMABLE) -->
                ...
                <details class="group">
                    ...
                    <div class="mt-4 pt-4 border-t border-slate-800 space-y-4 text-xs font-mono text-slate-300 leading-relaxed">
                        <div class="p-3 bg-slate-800 rounded-xl border border-slate-700">
                            ...
                            <p>1.1 b) $x = \frac{42}{-6} \implies \mathbf{x = -7}$ (1 pt)</p>
                            <p>1.2 $I = \frac{P}{U} = \frac{3450}{230} \implies \mathbf{I = 15 \text{ A}}$ (2 pts)</p>
                        </div>
                        ...
                        <div class="p-3 bg-slate-800 rounded-xl border border-slate-700">
                            ...
                            <p>2.2 $8x - 12 = 3x + 18 \implies 5x = 30 \implies \mathbf{x = 6}$ (2 pts)</p>
                        ...
                        <div class="p-3 bg-slate-800 rounded-xl border border-slate-700">
                            ...
                            <p>3.1 $C_A(x) = 35x + 240$ et $C_B(x) = 55x$ (2 pts)</p>
                            <p>3.2 Équation : $35x + 240 = 55x$ (2 pts)</p>
                            <p>3.3 $55x - 35x = 240 \implies 20x = 240 \implies \mathbf{x = 12 \text{ jours}}$ (2 pts)</p>
                            <p>3.4 Pour 15 jours ($x > 12$) : $C_A(15) = 35(15)+240 = 765$ € et $C_B(15) = 55(15) = 825$ €. <strong>Recommander le Tarif A</strong> (2 pts)</p>
                        </div>

                        <div class="p-3 bg-slate-800 rounded-xl border border-slate-700">
                            <h5 class="font-bold text-yellow-400 mb-1 font-sans">Corrigé Partie 4 (2 pts) :</h5>
                            <p>L'élève a confondu multiplication et addition. $-4x = 12 \implies x = \frac{12}{-3} \implies \mathbf{x = -3}$. (2 pts)</p>
                        </div>
                    </div>
                </details>
            </section>
...
fs.writeFileSync('ressources/seconde/maths/equations-1er-degre/eval.html', content, 'utf8');
console.log('Successfully updated eval.html for Seconde equations-1er-degre!');
