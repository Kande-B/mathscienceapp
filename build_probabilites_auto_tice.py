...
<body class="text-slate-800 bg-slate-50 min-h-screen pb-20">
    ...
    <main class="max-w-5xl mx-auto px-4 py-8 space-y-12">
        ...
        <div class="bg-slate-900 text-white p-6 rounded-3xl shadow-xl border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
                ...
                <p class="text-xs text-slate-400 mt-1">3 Modules — 10 Flashcards, 10 Questions QCM Chrono, 6 Calculs Rapides</p>
            </div>
        ...
        <section class="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 card-shadow space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4" id="fc-grid">
                ...
                <div class="h-48 perspective-1000 cursor-pointer" onclick="flipCard(this)">
                    <div class="relative w-full h-full transform-style-3d card-inner">
                        <div class="absolute w-full h-full bg-slate-900 text-white p-4 rounded-2xl flex flex-col justify-between backface-hidden border border-slate-800">
                            <span class="text-[10px] font-bold uppercase text-yellow-400">Flashcard 1</span>
                            <p class="text-xs font-bold text-center leading-relaxed">Probabilité d'un événement impossible ?</p>
                            <span class="text-[9px] text-slate-400 text-center">🔄 Cliquez pour voir</span>
                        </div>
                        <div class="absolute w-full h-full bg-yellow-500 text-slate-950 p-4 rounded-2xl flex flex-col justify-between backface-hidden rotate-y-180 border border-yellow-400">
                            ...
                            <p class="text-xs font-extrabold text-center leading-relaxed">Exactement $\mathbf{0}$ !</p>
                            <button onclick="event.stopPropagation(); markFC(1)" class="w-full bg-slate-950 text-white text-[10px] py-1.5 rounded-lg font-bold hover:bg-slate-800 transition-colors">✅ Maîtrisé !</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="h-48 perspective-1000 cursor-pointer" onclick="flipCard(this)">
                    <div class="relative w-full h-full transform-style-3d card-inner">
                        <div class="absolute w-full h-full bg-slate-900 text-white p-4 rounded-2xl flex flex-col justify-between backface-hidden border border-slate-800">
                            <span class="text-[10px] font-bold uppercase text-yellow-400">Flashcard 2</span>
                            <p class="text-xs font-bold text-center leading-relaxed">Probabilité d'un événement certain ?</p>
                            <span class="text-[9px] text-slate-400 text-center">🔄 Cliquez pour voir</span>
                        </div>
                        <div class="absolute w-full h-full bg-yellow-500 text-slate-950 p-4 rounded-2xl flex flex-col justify-between backface-hidden rotate-y-180 border border-yellow-400">
                            <span class="text-[10px] font-bold uppercase">Réponse</span>
                            <p class="text-xs font-extrabold text-center leading-relaxed">Exactement $\mathbf{1}$ (100%) !</p>
                            <button onclick="event.stopPropagation(); markFC(2)" class="w-full bg-slate-950 text-white text-[10px] py-1.5 rounded-lg font-bold hover:bg-slate-800 transition-colors">✅ Maîtrisé !</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="h-48 perspective-1000 cursor-pointer" onclick="flipCard(this)">
                    <div class="relative w-full h-full transform-style-3d card-inner">
                        <div class="absolute w-full h-full bg-slate-900 text-white p-4 rounded-2xl flex flex-col justify-between backface-hidden border border-slate-800">
                            <span class="text-[10px] font-bold uppercase text-yellow-400">Flashcard 3</span>
                            <p class="text-xs font-bold text-center leading-relaxed">Formule de $P(\bar{A})$ si $P(A) = 0{,}30$ ?</p>
                            <span class="text-[9px] text-slate-400 text-center">🔄 Cliquez pour voir</span>
                        </div>
                        <div class="absolute w-full h-full bg-yellow-500 text-slate-950 p-4 rounded-2xl flex flex-col justify-between backface-hidden rotate-y-180 border border-yellow-400">
                            <span class="text-[10px] font-bold uppercase">Réponse</span>
                            <p class="text-xs font-extrabold text-center leading-relaxed">$P(\bar{A}) = 1 - 0{,}30 = \mathbf{0{,}70}$</p>
                            <button onclick="event.stopPropagation(); markFC(3)" class="w-full bg-slate-950 text-white text-[10px] py-1.5 rounded-lg font-bold hover:bg-slate-800 transition-colors">✅ Maîtrisé !</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="h-48 perspective-1000 cursor-pointer" onclick="flipCard(this)">
                    <div class="relative w-full h-full transform-style-3d card-inner">
                        <div class="absolute w-full h-full bg-slate-900 text-white p-4 rounded-2xl flex flex-col justify-between backface-hidden border border-slate-800">
                            <span class="text-[10px] font-bold uppercase text-yellow-400">Flashcard 4</span>
                            <p class="text-xs font-bold text-center leading-relaxed">Signification de $A \cap B$ ?</p>
                            <span class="text-[9px] text-slate-400 text-center">🔄 Cliquez pour voir</span>
                        </div>
                        <div class="absolute w-full h-full bg-yellow-500 text-slate-950 p-4 rounded-2xl flex flex-col justify-between backface-hidden rotate-y-180 border border-yellow-400">
                            <span class="text-[10px] font-bold uppercase">Réponse</span>
                            <p class="text-xs font-extrabold text-center leading-relaxed">Événement $A$ **ET** $B$ simultanés</p>
                            <button onclick="event.stopPropagation(); markFC(4)" class="w-full bg-slate-950 text-white text-[10px] py-1.5 rounded-lg font-bold hover:bg-slate-800 transition-colors">✅ Maîtrisé !</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="h-48 perspective-1000 cursor-pointer" onclick="flipCard(this)">
                    <div class="relative w-full h-full transform-style-3d card-inner">
                        <div class="absolute w-full h-full bg-slate-900 text-white p-4 rounded-2xl flex flex-col justify-between backface-hidden border border-slate-800">
                            <span class="text-[10px] font-bold uppercase text-yellow-400">Flashcard 5</span>
                            <p class="text-xs font-bold text-center leading-relaxed">Signification de $A \cup B$ ?</p>
                            <span class="text-[9px] text-slate-400 text-center">🔄 Cliquez pour voir</span>
                        </div>
                        <div class="absolute w-full h-full bg-yellow-500 text-slate-950 p-4 rounded-2xl flex flex-col justify-between backface-hidden rotate-y-180 border border-yellow-400">
                            <span class="text-[10px] font-bold uppercase">Réponse</span>
                            <p class="text-xs font-extrabold text-center leading-relaxed">Événement $A$ **OU** $B$ (ou les deux)</p>
                            <button onclick="event.stopPropagation(); markFC(5)" class="w-full bg-slate-950 text-white text-[10px] py-1.5 rounded-lg font-bold hover:bg-slate-800 transition-colors">✅ Maîtrisé !</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="h-48 perspective-1000 cursor-pointer" onclick="flipCard(this)">
                    <div class="relative w-full h-full transform-style-3d card-inner">
                        <div class="absolute w-full h-full bg-slate-900 text-white p-4 rounded-2xl flex flex-col justify-between backface-hidden border border-slate-800">
                            <span class="text-[10px] font-bold uppercase text-yellow-400">Flashcard 6</span>
                            <p class="text-xs font-bold text-center leading-relaxed">Valeur de $P(A \cap B)$ si incompatibles ?</p>
                            <span class="text-[9px] text-slate-400 text-center">🔄 Cliquez pour voir</span>
                        </div>
                        <div class="absolute w-full h-full bg-yellow-500 text-slate-950 p-4 rounded-2xl flex flex-col justify-between backface-hidden rotate-y-180 border border-yellow-400">
                            <span class="text-[10px] font-bold uppercase">Réponse</span>
                            <p class="text-xs font-extrabold text-center leading-relaxed">$P(A \cap B) = \mathbf{0}$</p>
                            <button onclick="event.stopPropagation(); markFC(6)" class="w-full bg-slate-950 text-white text-[10px] py-1.5 rounded-lg font-bold hover:bg-slate-800 transition-colors">✅ Maîtrisé !</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="h-48 perspective-1000 cursor-pointer" onclick="flipCard(this)">
                    <div class="relative w-full h-full transform-style-3d card-inner">
                        <div class="absolute w-full h-full bg-slate-900 text-white p-4 rounded-2xl flex flex-col justify-between backface-hidden border border-slate-800">
                            <span class="text-[10px] font-bold uppercase text-yellow-400">Flashcard 7</span>
                            <p class="text-xs font-bold text-center leading-relaxed">$P(\text{Pile})$ avec une pièce équilibrée ?</p>
                            <span class="text-[9px] text-slate-400 text-center">🔄 Cliquez pour voir</span>
                        </div>
                        <div class="absolute w-full h-full bg-yellow-500 text-slate-950 p-4 rounded-2xl flex flex-col justify-between backface-hidden rotate-y-180 border border-yellow-400">
                            <span class="text-[10px] font-bold uppercase">Réponse</span>
                            <p class="text-xs font-extrabold text-center leading-relaxed">$\frac{1}{2} = \mathbf{0{,}50}$ (50%)</p>
                            <button onclick="event.stopPropagation(); markFC(7)" class="w-full bg-slate-950 text-white text-[10px] py-1.5 rounded-lg font-bold hover:bg-slate-800 transition-colors">✅ Maîtrisé !</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="h-48 perspective-1000 cursor-pointer" onclick="flipCard(this)">
                    <div class="relative w-full h-full transform-style-3d card-inner">
                        <div class="absolute w-full h-full bg-slate-900 text-white p-4 rounded-2xl flex flex-col justify-between backface-hidden border border-slate-800">
                            <span class="text-[10px] font-bold uppercase text-yellow-400">Flashcard 8</span>
                            <p class="text-xs font-bold text-center leading-relaxed">Formule de $P(A \cup B)$ ?</p>
                            <span class="text-[9px] text-slate-400 text-center">🔄 Cliquez pour voir</span>
                        </div>
                        <div class="absolute w-full h-full bg-yellow-500 text-slate-950 p-4 rounded-2xl flex flex-col justify-between backface-hidden rotate-y-180 border border-yellow-400">
                            <span class="text-[10px] font-bold uppercase">Réponse</span>
                            <p class="text-xs font-extrabold text-center leading-relaxed">$P(A) + P(B) - P(A \cap B)$</p>
                            <button onclick="event.stopPropagation(); markFC(8)" class="w-full bg-slate-950 text-white text-[10px] py-1.5 rounded-lg font-bold hover:bg-slate-800 transition-colors">✅ Maîtrisé !</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="h-48 perspective-1000 cursor-pointer" onclick="flipCard(this)">
                    <div class="relative w-full h-full transform-style-3d card-inner">
                        <div class="absolute w-full h-full bg-slate-900 text-white p-4 rounded-2xl flex flex-col justify-between backface-hidden border border-slate-800">
                            <span class="text-[10px] font-bold uppercase text-yellow-400">Flashcard 9</span>
                            <p class="text-xs font-bold text-center leading-relaxed">Loi des Grands Nombres ?</p>
                            <span class="text-[9px] text-slate-400 text-center">🔄 Cliquez pour voir</span>
                        </div>
                        <div class="absolute w-full h-full bg-yellow-500 text-slate-950 p-4 rounded-2xl flex flex-col justify-between backface-hidden rotate-y-180 border border-yellow-400">
                            <span class="text-[10px] font-bold uppercase">Réponse</span>
                            <p class="text-xs font-extrabold text-center leading-relaxed">Quand $N \to \infty$, $f \to \mathbf{p}$</p>
                            <button onclick="event.stopPropagation(); markFC(9)" class="w-full bg-slate-950 text-white text-[10px] py-1.5 rounded-lg font-bold hover:bg-slate-800 transition-colors">✅ Maîtrisé !</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="h-48 perspective-1000 cursor-pointer" onclick="flipCard(this)">
                    <div class="relative w-full h-full transform-style-3d card-inner">
                        <div class="absolute w-full h-full bg-slate-900 text-white p-4 rounded-2xl flex flex-col justify-between backface-hidden border border-slate-800">
                            <span class="text-[10px] font-bold uppercase text-yellow-400">Flashcard 10</span>
                            <p class="text-xs font-bold text-center leading-relaxed">Somme des probabilités de l'univers ?</p>
                            <span class="text-[9px] text-slate-400 text-center">🔄 Cliquez pour voir</span>
                        </div>
                        <div class="absolute w-full h-full bg-yellow-500 text-slate-950 p-4 rounded-2xl flex flex-col justify-between backface-hidden rotate-y-180 border border-yellow-400">
                            <span class="text-[10px] font-bold uppercase">Réponse</span>
                            <p class="text-xs font-extrabold text-center leading-relaxed">Somme $= \mathbf{1}$ (100%)</p>
                            <button onclick="event.stopPropagation(); markFC(10)" class="w-full bg-slate-950 text-white text-[10px] py-1.5 rounded-lg font-bold hover:bg-slate-800 transition-colors">✅ Maîtrisé !</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 card-shadow space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs" id="qcm-grid">
                <!-- Q1 -->
                <div class="p-4 bg-slate-50 rounded-2xl border space-y-3" id="qcm1-card">
                    <p class="font-bold text-slate-900">1. Si $P(A) = 0{,}40$, la probabilité de l'événement contraire $P(\bar{A})$ est :</p>
                    <div class="space-y-1.5 text-slate-700">
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm1" value="A" class="accent-emerald-600">
                            <span>A) $0{,}40$</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm1" value="B" class="accent-emerald-600">
                            <span>B) $0{,}60$</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm1" value="C" class="accent-emerald-600">
                            <span>C) $1{,}40$</span>
                        </label>
                    </div>
                </div>
                ...
                <!-- Q2 -->
                <div class="p-4 bg-slate-50 rounded-2xl border space-y-3" id="qcm2-card">
                    <p class="font-bold text-slate-900">2. Une probabilité est toujours un nombre compris entre :</p>
                    <div class="space-y-1.5 text-slate-700">
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm2" value="A" class="accent-emerald-600">
                            <span>A) $0$ et $1$</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm2" value="B" class="accent-emerald-600">
                            <span>B) $-1$ et $+1$</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm2" value="C" class="accent-emerald-600">
                            <span>C) $0$ et $100$</span>
                        </label>
                    </div>
                </div>

                <!-- Q3 -->
                <div class="p-4 bg-slate-50 rounded-2xl border space-y-3" id="qcm3-card">
                    <p class="font-bold text-slate-900">3. On tire une boule dans un sac (3 rouges, 5 bleues, 2 vertes). $P(\text{Rouge}) = $</p>
                    <div class="space-y-1.5 text-slate-700">
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm3" value="A" class="accent-emerald-600">
                            <span>A) $3/7$</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm3" value="B" class="accent-emerald-600">
                            <span>B) $3/5$</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm3" value="C" class="accent-emerald-600">
                            <span>C) $3/10 = 0{,}30$</span>
                        </label>
                    </div>
                </div>

                <!-- Q4 -->
                <div class="p-4 bg-slate-50 rounded-2xl border space-y-3" id="qcm4-card">
                    <p class="font-bold text-slate-900">4. Deux événements $A$ et $B$ sont dits incompatibles si :</p>
                    <div class="space-y-1.5 text-slate-700">
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm4" value="A" class="accent-emerald-600">
                            <span>A) $P(A \cup B) = 0$</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm4" value="B" class="accent-emerald-600">
                            <span>B) $P(A \cap B) = 0$</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm4" value="C" class="accent-emerald-600">
                            <span>C) $P(A) = P(B)$</span>
                        </label>
                    </div>
                </div>
                ...
                <!-- Q5 -->
                <div class="p-4 bg-slate-50 rounded-2xl border space-y-3" id="qcm5-card">
                    <p class="font-bold text-slate-900">5. La formule $P(A \cup B) = P(A) + P(B) - P(A \cap B)$ s'applique :</p>
                    <div class="space-y-1.5 text-slate-700">
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm5" value="A" class="accent-emerald-600">
                            <span>A) Pour tous les événements</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm5" value="B" class="accent-emerald-600">
                            <span>B) Uniquement si $P(A) = 0$</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm5" value="C" class="accent-emerald-600">
                            <span>C) Uniquement si $P(B) = 1$</span>
                        </label>
                    </div>
                </div>

                <!-- Q6 -->
                <div class="p-4 bg-slate-50 rounded-2xl border space-y-3" id="qcm6-card">
                    <p class="font-bold text-slate-900">6. Lors d'un tirage de dé équilibré, la probabilité d'avoir un 6 est :</p>
                    <div class="space-y-1.5 text-slate-700">
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm6" value="A" class="accent-emerald-600">
                            <span>A) $1/2$</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm6" value="B" class="accent-emerald-600">
                            <span>B) $1/6 \approx 0{,}167$</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm6" value="C" class="accent-emerald-600">
                            <span>C) $6/6 = 1$</span>
                        </label>
                    </div>
                </div>
                ...
                <!-- Q7 -->
                <div class="p-4 bg-slate-50 rounded-2xl border space-y-3" id="qcm7-card">
                    <p class="font-bold text-slate-900">7. Si $N$ passe de 10 à 1 000 lancers, la fréquence observée $f$ :</p>
                    <div class="space-y-1.5 text-slate-700">
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm7" value="A" class="accent-emerald-600">
                            <span>A) Devient imprévisible</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm7" value="B" class="accent-emerald-600">
                            <span>B) Se rapproche de la probabilité $p$</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm7" value="C" class="accent-emerald-600">
                            <span>C) Diminue vers 0</span>
                        </label>
                    </div>
                </div>

                <!-- Q8 -->
                <div class="p-4 bg-slate-50 rounded-2xl border space-y-3" id="qcm8-card">
                    <p class="font-bold text-slate-900">8. Si $P(A) = 0{,}25$, $P(B) = 0{,}35$ et incompatibles, $P(A \cup B) = $</p>
                    <div class="space-y-1.5 text-slate-700">
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm8" value="A" class="accent-emerald-600">
                            <span>A) $0{,}60$</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm8" value="B" class="accent-emerald-600">
                            <span>B) $0{,}10$</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm8" value="C" class="accent-emerald-600">
                            <span>C) $0{,}0875$</span>
                        </label>
                    </div>
                </div>
                ...
                <!-- Q9 -->
                <div class="p-4 bg-slate-50 rounded-2xl border space-y-3" id="qcm9-card">
                    <p class="font-bold text-slate-900">9. L'ensemble de toutes les issues possibles s'appelle :</p>
                    <div class="space-y-1.5 text-slate-700">
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm9" value="A" class="accent-emerald-600">
                            <span>A) L'échantillon</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm9" value="B" class="accent-emerald-600">
                            <span>B) La fréquence</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm9" value="C" class="accent-emerald-600">
                            <span>C) L'Univers $\Omega$</span>
                        </label>
                    </div>
                </div>

                <!-- Q10 -->
                <div class="p-4 bg-slate-50 rounded-2xl border space-y-3" id="qcm10-card">
                    <p class="font-bold text-slate-900">10. 25 cartes défectueuses sur 500. La probabilité de défaut est :</p>
                    <div class="space-y-1.5 text-slate-700">
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm10" value="A" class="accent-emerald-600">
                            <span>A) $0{,}025$</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm10" value="B" class="accent-emerald-600">
                            <span>B) $25/500 = 0{,}05 = 5\%$</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                            <input type="radio" name="qcm10" value="C" class="accent-emerald-600">
                            <span>C) $0{,}50$</span>
                        </label>
                    </div>
                </div>
    ...
    <!-- JS POUR AUTOMATISMES ET SCOREBOARD -->
    <script>
