    ...
    <main class="max-w-5xl mx-auto px-4 py-8 space-y-12">
        ...
        <section class="bg-slate-900 text-white p-6 md:p-8 rounded-3xl border border-slate-800 shadow-xl space-y-6">
            ...
            <div id="quiz-container" class="space-y-4 text-xs">
                ...
                <!-- Q3 -->
                <div class="p-4 bg-slate-800 rounded-2xl border border-slate-700 space-y-2">
                    <p class="font-bold text-white">Q3 (5 pts) : Quel est le sens de variation de $f(x) = -3x + 12$ ?</p>
                    <div class="flex flex-wrap gap-2">
                        <button onclick="checkAnswer(this, 3, true, 5)" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-xl transition-colors">A) Strictement Décroissante (car a = -3 < 0)</button>
                        <button onclick="checkAnswer(this, 3, false, 5)" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-xl transition-colors">B) Strictement Croissante</button>
                    </div>
                </div>

                <!-- Q4 -->
                <div class="p-4 bg-slate-800 rounded-2xl border border-slate-700 space-y-2">
                    <p class="font-bold text-white">Q4 (5 pts) : Quel est le minimum de la fonction carré $f(x) = x^2$ sur $\mathbb{R}$ ?</p>
                    <div class="flex flex-wrap gap-2">
                        <button onclick="checkAnswer(this, 4, true, 5)" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-xl transition-colors">A) Minimum égal à 0 pour x = 0</button>
                        <button onclick="checkAnswer(this, 4, false, 5)" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-xl transition-colors">B) Pas de minimum</button>
                    </div>
                </div>
...
<body class="text-slate-800 bg-slate-50 min-h-screen pb-20">
    ...
    <main class="max-w-5xl mx-auto px-4 py-8 space-y-12">
        ...
        <div class="space-y-6 text-xs">
            ...
            <section class="bg-white p-6 rounded-3xl border border-slate-200 card-shadow space-y-4">
                <div class="flex items-center justify-between border-b border-slate-100 pb-3">
                    <span class="font-bold text-indigo-700 uppercase tracking-wider text-xs bg-indigo-50 px-3 py-1 rounded-full">Exercice 3 • Étude de la Fonction Inverse</span>
                    <span class="text-slate-400 font-medium">Capacité C3 • 4 points</span>
                </div>
                <p class="font-bold text-slate-900">Soit $h(x) = \frac{1}{x}$ sur $\mathbb{R}^*$.</p>
                <p class="text-slate-800">Calculer $h(0,5)$, $h(-4)$ et résoudre $h(x) = 5$.</p>

                <details class="bg-slate-50 border border-slate-200 rounded-xl p-4">
                    <summary class="cursor-pointer font-bold text-indigo-700 hover:text-indigo-900">Consulter les corrigés rédigés</summary>
                    <div class="mt-3 space-y-2 font-mono text-slate-700 leading-relaxed border-t border-slate-200 pt-3">
                        <p>• $h(0,5) = \frac{1}{0,5} = \mathbf{2}$.</p>
                        <p>• $h(-4) = \frac{1}{-4} = \mathbf{-0,25}$.</p>
                        <p>• $h(x) = 5 \implies \frac{1}{x} = 5 \implies \mathbf{x = \frac{1}{5} = 0,2}$.</p>
                    </div>
                </details>
            </section>
            ...
            <section class="bg-white p-6 rounded-3xl border border-slate-200 card-shadow space-y-4">
                <div class="flex items-center justify-between border-b border-slate-100 pb-3">
                    <span class="font-bold text-emerald-700 uppercase tracking-wider text-xs bg-emerald-50 px-3 py-1 rounded-full">Exercice 4 • Problème Pro Maintenance Automobile</span>
                    <span class="text-slate-400 font-medium">Capacité C1 à C4 • 4 points</span>
                </div>
                <p class="text-slate-800 leading-relaxed">
                    Sur un banc d'essai, la puissance $P(v)$ d'un moteur en chevaux dépend de la vitesse de rotation $v$ en milliers de tr/min selon : $P(v) = -10v^2 + 80v$. <br>
                ...
                <details class="bg-slate-50 border border-slate-200 rounded-xl p-4">
                    ...
                    <div class="mt-3 space-y-2 text-slate-700 border-t border-slate-200 pt-3 font-mono">
                        <p>La parabole a ses branches tournées vers le bas ($a = -10 < 0$).</p>
                        <p>Le sommet est à $v = 4$ (4000 tr/min).</p>
                        <p>Puissance max : $P(4) = -10(4)^2 + 80(4) = -160 + 320 = \mathbf{160 \text{ ch}}$.</p>
                    </div>
                </details>
            </section>
...
<body class="text-slate-800 bg-slate-50 min-h-screen pb-20">
    ...
    <main class="max-w-5xl mx-auto px-4 py-8 space-y-12">
        ...
        <div class="space-y-6 text-xs">
            ...
            <section class="bg-white p-6 rounded-3xl border border-slate-200 card-shadow space-y-4">
                <div class="flex items-center justify-between border-b border-slate-100 pb-3">
                    <h3 class="font-bold text-slate-900 text-sm">Partie 3 • Problème Pro Contextualisé (8 Points)</h3>
                ...
                <div class="space-y-3 text-slate-700 leading-relaxed">
                    <div class="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-2">
                        ...
                        <p>
                            Un atelier de maintenance teste un composant électronique. La puissance $P(i)$ consommée en Watts dépend de l'intensité $i$ (en Ampères) selon : $P(i) = 15 i^2$. <br>
                            1. Calculer la puissance consommée pour $i = 2$ A, puis pour $i = 4$ A. <br>
            ...
            <section class="bg-white p-6 rounded-3xl border border-slate-200 card-shadow space-y-4">
                <div class="flex items-center justify-between border-b border-slate-100 pb-3">
                    <h3 class="font-bold text-slate-900 text-sm">Partie 4 • Analyse Critique (2 Points)</h3>
                    <span class="bg-slate-100 text-slate-700 font-bold px-2.5 py-1 rounded-full text-[11px]">2 Pts</span>
                </div>

                <div class="space-y-2 text-slate-700">
                    <p class="font-semibold text-slate-900">Un élève affirme que l'image de $-5$ par $f(x) = x^2$ est $-25$.</p>
                    <p class="text-slate-800">Expliquer son erreur et donner le bon résultat.</p>
                </div>
            </section>
                ...
                <details class="group">
                    ...
                    <div class="mt-4 pt-4 border-t border-slate-800 space-y-4 text-xs font-mono text-slate-300 leading-relaxed">
                        ...
                        <div class="p-3 bg-slate-800 rounded-xl border border-slate-700">
                            ...
                            <p>3.1 $P(2) = 15(2)^2 = \mathbf{60 \text{ W}}$ et $P(4) = 15(4)^2 = \mathbf{240 \text{ W}}$ (4 pts)</p>
                            <p>3.2 $15i^2 = 240 \implies i^2 = 16 \implies \mathbf{i = 4 \text{ A}}$ (4 pts)</p>
                        </div>
                        <div class="p-3 bg-slate-800 rounded-xl border border-slate-700">
                            <h5 class="font-bold text-yellow-400 mb-1 font-sans">Corrigé Partie 4 (2 pts) :</h5>
                            <p>L'élève a oublié de mettre des parenthèses autour du nombre négatif. $(-5)^2 = (-5) \times (-5) = \mathbf{+25}$. (2 pts)</p>
                        </div>
                    </div>
                </details>
            </section>
