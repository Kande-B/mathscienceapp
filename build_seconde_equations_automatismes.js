...
<head>
    ...
    <title>Automatismes & Rituels - Équations 1er Degré (Seconde Pro)</title>
    <!-- Tailwind CSS -->
...
<body class="text-slate-800 bg-slate-50 min-h-screen pb-20">
    ...
    <main class="max-w-5xl mx-auto px-4 py-8 space-y-12">
        ...
        <div class="bg-slate-900 text-white p-6 md:p-8 rounded-3xl shadow-xl border border-slate-800 space-y-4">
            <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div>
                    ...
                    <h2 class="text-3xl font-extrabold font-heading text-white">Automatismes : Équations du 1er Degré</h2>
                    <p class="text-sm text-slate-300 max-w-2xl">Mémorisez les règles d'isolation de l'inconnue, entraînez vos réflexes avec 10 Flashcards 3D interactives et mesurez votre score au Défi Autonome sur 20 points.</p>
                </div>
            </div>
        </div>

        <!-- SECTION 1 : 10 FLASHCARDS 3D INTERACTIVES -->
        <section class="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 card-shadow space-y-6">
            <div class="flex items-center justify-between border-b border-slate-100 pb-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-xl font-bold font-heading text-slate-900">10 Flashcards 3D de Révision</h3>
                        <p class="text-xs text-slate-500 font-medium">Cliquez sur une carte pour faire pivoter et découvrir la réponse</p>
                    </div>
                </div>
            </div>

            <!-- Grille des 10 Flashcards -->
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="perspective-1000 h-44 cursor-pointer" onclick="this.querySelector('.transform-style-3d').classList.toggle('rotate-y-180')">
                    <div class="transform-style-3d relative w-full h-full">
                        ...
                        <div class="backface-hidden absolute inset-0 bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-2xl p-5 flex flex-col justify-between border border-slate-700 shadow-md">
                            <span class="text-[10px] font-extrabold uppercase tracking-widest text-yellow-400">Flashcard 1</span>
                            <div class="text-center font-bold text-base">Résoudre : <br><span class="text-sky-300">$x + 12 = 30$</span></div>
                        ...
                        <div class="backface-hidden rotate-y-180 absolute inset-0 bg-emerald-600 text-white rounded-2xl p-5 flex flex-col justify-between shadow-md">
                            ...
                            <div class="text-center font-bold text-sm leading-relaxed">
                                $x = 30 - 12$ <br>
                                <span class="text-xl text-yellow-300 font-mono">$x = 18$</span>
                            </div>
                            <span class="text-[10px] text-emerald-200 text-center">Règle de la soustraction</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="perspective-1000 h-44 cursor-pointer" onclick="this.querySelector('.transform-style-3d').classList.toggle('rotate-y-180')">
                    <div class="transform-style-3d relative w-full h-full">
                        <div class="backface-hidden absolute inset-0 bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-2xl p-5 flex flex-col justify-between border border-slate-700 shadow-md">
                            <span class="text-[10px] font-extrabold uppercase tracking-widest text-yellow-400">Flashcard 2</span>
                            <div class="text-center font-bold text-base">Résoudre : <br><span class="text-sky-300">$-4x = 28$</span></div>
                            <span class="text-[10px] text-slate-400 text-center">Cliquez pour voir le verso <i class="fa-solid fa-rotate mr-1"></i></span>
                        </div>
                        <div class="backface-hidden rotate-y-180 absolute inset-0 bg-emerald-600 text-white rounded-2xl p-5 flex flex-col justify-between shadow-md">
                ...
                <div class="perspective-1000 h-44 cursor-pointer" onclick="this.querySelector('.transform-style-3d').classList.toggle('rotate-y-180')">
                    <div class="transform-style-3d relative w-full h-full">
                        <div class="backface-hidden absolute inset-0 bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-2xl p-5 flex flex-col justify-between border border-slate-700 shadow-md">
                            <span class="text-[10px] font-extrabold uppercase tracking-widest text-yellow-400">Flashcard 3</span>
                            <div class="text-center font-bold text-base">Résoudre : <br><span class="text-sky-300">$3x - 5 = 16$</span></div>
                            <span class="text-[10px] text-slate-400 text-center">Cliquez pour voir le verso <i class="fa-solid fa-rotate mr-1"></i></span>
                        </div>
                        <div class="backface-hidden rotate-y-180 absolute inset-0 bg-emerald-600 text-white rounded-2xl p-5 flex flex-col justify-between shadow-md">
                            ...
                            <span class="text-[10px] text-emerald-200 text-center">Résolution en 2 étapes</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="perspective-1000 h-44 cursor-pointer" onclick="this.querySelector('.transform-style-3d').classList.toggle('rotate-y-180')">
                    <div class="transform-style-3d relative w-full h-full">
                        <div class="backface-hidden absolute inset-0 bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-2xl p-5 flex flex-col justify-between border border-slate-700 shadow-md">
                            <span class="text-[10px] font-extrabold uppercase tracking-widest text-yellow-400">Flashcard 5</span>
                            <div class="text-center font-bold text-base">Résoudre : <br><span class="text-sky-300">$5x = 2x + 18$</span></div>
                            <span class="text-[10px] text-slate-400 text-center">Cliquez pour voir le verso <i class="fa-solid fa-rotate mr-1"></i></span>
                        </div>
                        <div class="backface-hidden rotate-y-180 absolute inset-0 bg-emerald-600 text-white rounded-2xl p-5 flex flex-col justify-between shadow-md">
                ...
                <div class="perspective-1000 h-44 cursor-pointer" onclick="this.querySelector('.transform-style-3d').classList.toggle('rotate-y-180')">
                    <div class="transform-style-3d relative w-full h-full">
                        <div class="backface-hidden absolute inset-0 bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-2xl p-5 flex flex-col justify-between border border-slate-700 shadow-md">
                            <span class="text-[10px] font-extrabold uppercase tracking-widest text-yellow-400">Flashcard 6</span>
                            <div class="text-center font-bold text-base">Résoudre : <br><span class="text-sky-300">$(x - 9)(x + 4) = 0$</span></div>
                            <span class="text-[10px] text-slate-400 text-center">Cliquez pour voir le verso <i class="fa-solid fa-rotate mr-1"></i></span>
                        </div>
                        <div class="backface-hidden rotate-y-180 absolute inset-0 bg-emerald-600 text-white rounded-2xl p-5 flex flex-col justify-between shadow-md">
        ...
        <!-- SECTION 2 : CHALLENGE INTERACTIF AUTONOME SUR 20 POINTS -->
        <section class="bg-slate-900 text-white p-6 md:p-8 rounded-3xl border border-slate-800 shadow-xl space-y-6">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800 pb-4">
                <div>
                    ...
                    <h3 class="text-2xl font-bold font-heading text-white mt-1"><i class="fa-solid fa-trophy text-yellow-400 mr-2"></i> Challenge Flash Équations (Sur 20 Points)</h3>
                </div>
            ...
            <div id="quiz-container" class="space-y-4 text-xs">
                ...
                <div class="p-4 bg-slate-800 rounded-2xl border border-slate-700 space-y-2">
                    <p class="font-bold text-white">Q1 (2 pts) : Quelle est la solution de $x - 19 = -5$ ?</p>
                    <div class="flex flex-wrap gap-2">
                        <button onclick="checkAnswer(this, 1, true, 2)" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-xl transition-colors">A) x = 14</button>
                        <button onclick="checkAnswer(this, 1, false, 2)" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-xl transition-colors">B) x = -24</button>
                        <button onclick="checkAnswer(this, 1, false, 2)" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-xl transition-colors">C) x = 24</button>
                    </div>
                </div>

                <!-- Q2 -->
                <div class="p-4 bg-slate-800 rounded-2xl border border-slate-700 space-y-2">
                    <p class="font-bold text-white">Q2 (2 pts) : Quelle est la solution de $6x = -42$ ?</p>
                    <div class="flex flex-wrap gap-2">
                        <button onclick="checkAnswer(this, 2, false, 2)" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-xl transition-colors">A) x = 7</button>
                        <button onclick="checkAnswer(this, 2, true, 2)" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-xl transition-colors">B) x = -7</button>
                        <button onclick="checkAnswer(this, 2, false, 2)" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-xl transition-colors">C) x = -36</button>
                    </div>
                </div>

                <!-- Q3 -->
                <div class="p-4 bg-slate-800 rounded-2xl border border-slate-700 space-y-2">
                    <p class="font-bold text-white">Q3 (2 pts) : Résoudre $5x + 10 = 35$.</p>
                    <div class="flex flex-wrap gap-2">
                        <button onclick="checkAnswer(this, 3, true, 2)" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-xl transition-colors">A) x = 5</button>
                        <button onclick="checkAnswer(this, 3, false, 2)" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-xl transition-colors">B) x = 9</button>
                        <button onclick="checkAnswer(this, 3, false, 2)" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-xl transition-colors">C) x = 25</button>
                    </div>
                </div>

                <!-- Q4 -->
                <div class="p-4 bg-slate-800 rounded-2xl border border-slate-700 space-y-2">
                    <p class="font-bold text-white">Q4 (2 pts) : Résoudre $8x - 4 = 3x + 21$.</p>
                    <div class="flex flex-wrap gap-2">
                        <button onclick="checkAnswer(this, 4, false, 2)" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-xl transition-colors">A) x = 3</button>
                        <button onclick="checkAnswer(this, 4, true, 2)" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-xl transition-colors">B) x = 5</button>
                        <button onclick="checkAnswer(this, 4, false, 2)" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-xl transition-colors">C) x = 17</button>
                    </div>
                </div>
                ...
                <div class="p-4 bg-slate-800 rounded-2xl border border-slate-700 space-y-2">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <button onclick="checkAnswer(this, 5, false, 2)" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-xl transition-colors">C) d = t / v</button>
                    </div>
                </div>
