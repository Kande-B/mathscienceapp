...
const newScript = `<!-- SCRIPT DU SIMULATEUR 3D WEBGL (THREE.JS) -->
    <script>
        ...
        // ==========================================
        // 2. PYRAMIDE À BASE CARRÉE (Pliage VERS LE HAUT)
        // ==========================================
        ...
        // ==========================================
        // 4. CYLINDRE DE RÉVOLUTION (Enroulement 3D ajusté)
        // ==========================================
        function buildCylinder3D(fp) {
            ...
            // Note: On incline les bandes verticales en position debout progressive
            if (f > 0.001) {
        ...
        // ==========================================
        // 5. CÔNE DE RÉVOLUTION (Enroulement 3D ajusté)
        // ==========================================
