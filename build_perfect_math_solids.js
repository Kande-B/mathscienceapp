...
const newScript = `<!-- SCRIPT DU SIMULATEUR 3D WEBGL (THREE.JS) -->
    <script>
        ...
        // ==========================================
        // 2. PYRAMIDE À BASE CARRÉE (Sommet parfait au-dessus du sol)
        // ==========================================
        function buildPyramid3D(fp) {
            ...
            const alphaClose = Math.atan2(h, s/2);
            // Angle de rotation par rapport au plan horizontal pour rejoindre le sommet (0 à 180°-alphaClose)
            const targetAngle = Math.PI - alphaClose;
            const fa = fp * targetAngle;
        ...
        // ==========================================
        // 4. CYLINDRE DE RÉVOLUTION (Disques ajustés)
        // ==========================================
...
console.log('Applied mathematical angle fix to cours.html for ALL 5 SOLIDS!');
