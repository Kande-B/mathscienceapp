...
<head>
    ...
    <title>TP Numérique & TICE - Équations 1er Degré (Seconde Pro)</title>
    <!-- Tailwind CSS -->
    ...
    <main class="max-w-5xl mx-auto px-4 py-8 space-y-12">
        ...
        <div class="bg-slate-900 text-white p-6 md:p-8 rounded-3xl shadow-xl border border-slate-800 space-y-4">
            <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div>
                    ...
                    <h2 class="text-3xl font-extrabold font-heading text-white">Résolution Numérique & Graphique d'Équations</h2>
                    <p class="text-sm text-slate-300 max-w-2xl">Utilisation du Tableur (LibreOffice Calc / Excel) et du logiciel de géométrie dynamique GeoGebra pour valider graphiquement et automatiquement des solutions algébriques.</p>
                </div>
            </div>
        </div>
        ...
        <section class="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 card-shadow space-y-6">
            <div class="flex items-center gap-3 border-b border-slate-100 pb-4">
                ...
                <div>
                    ...
                    <h3 class="text-xl font-bold font-heading text-slate-900">Méthode du Balayage & Recherche d'Objectif</h3>
                </div>
            </div>

            <div class="space-y-4 text-xs leading-relaxed">
                <p class="text-slate-700">On souhaite résoudre l'équation $6x - 15 = 2x + 25$ à l'aide d'une feuille de calcul.</p>

                <!-- Tableau Modèle Tableur -->
                <div class="bg-slate-50 p-4 rounded-2xl border border-slate-200 space-y-3">
                    <h4 class="font-bold text-slate-900 text-xs">1. Structure de la Feuille de Calcul :</h4>
                        ...
                        <table class="w-full text-center border-collapse border border-slate-300 text-xs font-mono">
                            <thead>
                                <tr class="bg-slate-200 text-slate-700 font-bold">
                                    ...
                                    <th class="border border-slate-300 px-4 py-1.5">A (x)</th>
                                    <th class="border border-slate-300 px-4 py-1.5">B (Membre 1 : 6x - 15)</th>
                                    <th class="border border-slate-300 px-4 py-1.5">C (Membre 2 : 2x + 25)</th>
                                    <th class="border border-slate-300 px-4 py-1.5">D (Test Égalité)</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="bg-white">
                                    <td class="border border-slate-300 px-2 py-1 font-bold bg-slate-100">1</td>
                                    <td class="border border-slate-300 px-2 py-1">Valeur de x</td>
                                    <td class="border border-slate-300 px-2 py-1">=6*A2 - 15</td>
                                    <td class="border border-slate-300 px-2 py-1">=2*A2 + 25</td>
                                    <td class="border border-slate-300 px-2 py-1">=SI(B2=C2; "ÉGAL !"; "Différent")</td>
                                </tr>
                                <tr class="bg-emerald-50 font-bold">
                                    <td class="border border-slate-300 px-2 py-1 font-bold bg-slate-100">2</td>
                                    <td class="border border-slate-300 px-2 py-1 text-emerald-800">10</td>
                                    <td class="border border-slate-300 px-2 py-1 text-emerald-800">45</td>
                                    <td class="border border-slate-300 px-2 py-1 text-emerald-800">45</td>
                                    <td class="border border-slate-300 px-2 py-1 text-emerald-700">ÉGAL !</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="p-4 bg-sky-50 border border-sky-200 rounded-xl space-y-2 text-sky-950">
                    <h5 class="font-bold text-xs flex items-center gap-1.5"><i class="fa-solid fa-lightbulb"></i> Astuce Recherche d'Objectif (Excel / Calc) :</h5>
                    <p class="text-[11px]">Menu <strong>Données > Recherche d'objectif</strong> : Fixer la cellule B2 à la valeur de C2 en modifiant la cellule A2. Le tableur trouve la valeur exacte de $x = 10$ instantanément !</p>
                </div>
            </div>
        </section>
        ...
        <section class="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 card-shadow space-y-6">
            <div class="flex items-center gap-3 border-b border-slate-100 pb-4">
                ...
                <div>
                    <span class="text-xs font-bold text-purple-600 uppercase tracking-wider">Partie 2 • GeoGebra Géométrie Dynamique</span>
                    <h3 class="text-xl font-bold font-heading text-slate-900">Résolution Graphique par Intersection de Droites</h3>
                </div>
            </div>

            <div class="space-y-4 text-xs leading-relaxed">
                <p class="text-slate-700">Toute équation du 1er degré $ax + b = cx + d$ peut être résolue graphiquement en traçant les deux droites d'équations $y = ax + b$ et $y = cx + d$.</p>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="p-4 bg-slate-50 border border-slate-200 rounded-xl space-y-2">
                        <span class="font-bold text-purple-700 text-xs">Étape 1 : Saisie de la 1ère droite</span>
                        <p class="font-mono text-slate-800">Saisir dans la barre d'entrée : <br><code>f(x) = 6x - 15</code></p>
                    </div>
                    <div class="p-4 bg-slate-50 border border-slate-200 rounded-xl space-y-2">
                        <span class="font-bold text-purple-700 text-xs">Étape 2 : Saisie de la 2ème droite</span>
                        <p class="font-mono text-slate-800">Saisir dans la barre d'entrée : <br><code>g(x) = 2x + 25</code></p>
                    </div>
                </div>
